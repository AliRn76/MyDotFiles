...
mytextclock = wibox.widget.textclock(s)
...
awful.screen.connect_for_each_screen(function(s)
    ...
    -- Create the wibox
    s.mywibox = awful.wibar({ position = "top",  type = desktop , screen = s , bg = "#1a2026" , fg = "#fbdf90" , input_passthrough = true })
...
-- screenshot
    ...
    awful.key({ }, "Print", function () awful.spawn.with_shell("sshoot") end,
