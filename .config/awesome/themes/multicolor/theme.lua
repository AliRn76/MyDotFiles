...
theme.weather = lain.widget.weather({
    ...
    weather_na_markup = markup.fontfg(theme.font, "#ff8c00", "N/A "),
    settings = function()
        descr = weather_now["weather"][1]["description"]:lower()
        units = math.floor(weather_now["main"]["temp"])
        widget:set_markup(markup.fontfg(theme.font, "#ff8c00", descr .. " @ " .. units .. "°C "))
    end
})
...
local cpu = lain.widget.cpu({
    settings = function()
        widget:set_markup(markup.fontfg(theme.font, "#ff8c00", cpu_now.usage .. "% "))
    end
})
...
local netupinfo = lain.widget.net({
    settings = function()
        ...
        widget:set_markup(markup.fontfg(theme.font, "#000000", net_now.sent .. " "))
