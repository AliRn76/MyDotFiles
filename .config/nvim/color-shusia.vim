...
if s:configuration.transparent_background
  ...
  if s:configuration.sign_column_background ==# 'shusia'
...
elseif (&relativenumber == 1 && &cursorline == 0) || s:configuration.sign_column_background !=# 'shusia'
...
if s:configuration.transparent_background || s:configuration.sign_column_background !=# 'shusia'
